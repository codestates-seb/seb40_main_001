...
public interface CommentRepository extends JpaRepository<Comment, Long> {
    ...
    List<Comment> findAllByExerciseOrderByCommentId(Exercise exercise, Pageable page);

    List<Comment> findAllByExerciseAndCommentIdGreaterThanOrderByCommentId(Exercise exercise, Long id, Pageable page);
