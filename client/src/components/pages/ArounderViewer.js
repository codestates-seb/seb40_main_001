...
const ArounderViewer = ({ userId }) => {
  ...
  //   const response = await client.get(`/exercises/${exercies - id}`);
  ...
  return (
    <div className="flex flex-col justify-center items-center overflow: auto;">
      ...
      {/* <DetailContents dummyData={contentsData} img={contentsData.host.image} />
      <ApplicantSet dummyData={dummyData} writer={contentsData.host.memberId} /> */}
      <InputComments
        target="댓글을"
      ...
      <ViewerComments
        target="답글을"
        // writer={contentsData.host.memberId}
        userId={userId}
      />
